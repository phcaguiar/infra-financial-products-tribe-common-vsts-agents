# Service Variables
variable "nic_inf_lnx_vsts_aq_name" {
  description = "Set a name for your nic."
}

variable "nic_ip_conf_inf_lnx_vsts_aq_name" {
  description = "Set a name for your IC IP configuration."
}

# Virtual machine variables
variable "vm_inf_lnx_vsts_aq_name" {
  description = "Set a name for your virtual machine."
}

variable "vm_inf_lnx_vsts_aq_size" {
...
variable "vm_storage_os_disk_inf_lnx_vsts_aq_caching" {
...
variable "vm_storage_os_inf_lnx_vsts_aq_create_option" {
...
variable "vm_storage_os_managed_disk_inf_lnx_vsts_aq_type" {
